...
public class MyEESwift4Codegen extends DefaultCodegen implements CodegenConfig {
    private static final Logger LOGGER = LoggerFactory.getLogger(MyEESwift4Codegen.class);
    ...
    // MyEE specific configuration
    private List<String> apiReturnModels = new ArrayList<>();

    /**
     * Constructor for the swift4 language codegen module.
     */
    public MyEESwift4Codegen() {
        super();
    ...
    public String getHelp() {
        return "Generates a Swift 4.x client library for MyEE";
    }
        ...
        if (allDefinitions != null) {
            ...
            while (parentSchema != null) {
                ...
                final CodegenModel parentCodegenModel = super.fromModel(codegenModel.parent,
                        parentModel);
                codegenModel = MyEESwift4Codegen.reconcileProperties(codegenModel, parentCodegenModel);
    ...
    public Map<String, Object> postProcessModels(Map<String, Object> objs) {
        ...
        for (Object _mo : models) {
            ...
            // MyEE logic
            if (apiReturnModels.contains(cm.classname)) {
            	cm.vendorExtensions.put("x-is-api-return-type", true);
            }
        }
    ...
    public Map<String, Object> postProcessOperationsWithModels(Map<String, Object> objs, List<Object> allModels) {
        ...
        for (CodegenOperation operation : operations) {
        	if ("GET".equals(operation.httpMethod)) {
